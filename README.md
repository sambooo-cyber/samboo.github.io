...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;700&family=Caveat:wght@400;700&family=Dancing+Script:wght@400;700&display=swap" rel="stylesheet">
    <style>
        body {
            font-family: 'Playfair Display', serif;
            background: linear-gradient(135deg, #ffeff5 0%, #ffe4e6 50%, #fce7f3 100%);
            min-height: 100vh;
            margin: 0;
            padding: 20px;
        }
    ...
    <div class="relative z-10 max-w-4xl w-full space-y-10 px-4">
        ...
        <div class="message-card p-10 fade-in">
            <div class="romantic-text text-center">
                ...
                <p class="text-2xl text-rose-700 mt-8">
